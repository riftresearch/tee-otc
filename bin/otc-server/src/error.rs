...
impl From<crate::services::swap_manager::SwapError> for OtcServerError {
    fn from(err: crate::services::swap_manager::SwapError) -> Self {
        ...
        match err {
            ...
            SwapError::MarketMakerNotInGoodStanding { .. } => OtcServerError::ServiceUnavailable {
                service: "Market maker temporarily unavailable".to_string(),
            },
            ...
            SwapError::BadRefundRequest { reason } => {
                OtcServerError::BadRequest { message: reason }
            }
