...
async fn test_deposit_vault_consumes_on_fill(
    ...
    vault
        .store_deposit(
            &Deposit::new("k1", eth_native(5), "tx1"),
            utc::now(),
            Uuid::now_v7(),
        )
        .await
    ...
    vault
        .store_deposit(
            &Deposit::new("k2", eth_native(7), "tx2"),
            utc::now(),
            Uuid::now_v7(),
        )
        .await
